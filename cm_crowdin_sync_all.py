...
proc = subprocess.Popen(['crowdin-cli', '-c', 'crowdin/crowdin_aosp.yaml', 'list', 'sources'],stdout=subprocess.PIPE) # fetch non-AOSP supp.
proc += subprocess.Popen(['crowdin-cli', '-c', 'crowdin/crowdin_cm.yaml', 'list', 'sources'],stdout=subprocess.PIPE) # fetch AOSP supp.
