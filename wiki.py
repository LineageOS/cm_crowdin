...
def get_proofreaders(project_ids, languages):
    ...
    for project_id in project_ids:
        for language in languages:
            if language not in proofreaders:
                proofreaders.setdefault(
                    language, {"name": languages[language]["name"], "users": []}
                )
            ...
            if language in users_to_append:
                for u in users_to_append[language]["users"]:
                    if u not in proofreaders[language]["users"]:
                        proofreaders[language]["users"].append(u)
