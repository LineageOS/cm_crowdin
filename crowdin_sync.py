...
#parser.add_argument('--api-key-aosp', help='API key for the Crowdin AOSP project', required=True)
#parser.add_argument('--api-key-cm', help='API key for the Crowdin CM project', required=True)
...
xml_js = minidom.parse('crowdin/caf.xml')
items_js = xml_js.getElementsByTagName('project')

# Default branch
default_branch = get_default_branch(xml)
