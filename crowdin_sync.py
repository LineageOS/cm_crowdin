...
def upload_translations_crowdin(branch, config, crowdin_path):
    if config:
        ...
        print("\nUploading translations to Crowdin " "(AOSP supported languages)")
        check_run(
            [
                crowdin_path,
                "upload",
        ...
        print("\nUploading translations to Crowdin " "(non-AOSP supported languages)")
        check_run(
            [
                crowdin_path,
                "upload",
...
def download_crowdin(base_path, branch, xml, username, config, crowdin_path):
    if config:
        ...
        headers = ["AOSP supported languages", "non-AOSP supported languages"]
        config_files = [f"{branch}.yaml", f"{branch}_aosp.yaml"]
